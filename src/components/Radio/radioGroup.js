...
export default  class RadioGroup extends Component{
    constructor(props, context){
        ...
        this.prevSelecteds = this.props.selectedValue;
    ...
    componentWillReceiveProps(nextProps){
       ...
       // console.log('nextProps.selectedValue',nextProps.selectedValue)
        if(nextProps.selectedValue != this.prevSelecteds){
            this.prevSelecteds = nextProps.selectedValue
            this.setState({
    ...
    render(){
        var radioButtons = React.Children.map(this.props.children, (radioButton:any, index,value) => {
            // let isSelected = this.state.selectedIndex == index
            let isSelected = this.state.selectedValue == radioButton.props.value;
